...
adb shell am force-stop --user 10 com.example.nyasaplayer; sleep 2
adb shell am start --user 10 -n com.example.nyasaplayer/com.example.nyasaplayer.auto.ui.AutomotiveActivity >/dev/null; sleep 18
miss=0; valid=0
