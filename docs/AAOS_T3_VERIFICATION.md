...
Both gaps this record first listed — the D56 re-check and the missing-state case — were closed
later the same day; each has its own section below. What remains unverified is one thing:
